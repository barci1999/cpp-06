...
/*   Updated: 2025/10/21 20:13:23 by pablalva         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{	
	...
	char *end;
    errno = 0; 
    long long value = std::strtoll(this->_args[1].c_str(), &end, 10);
...
void ParserScalar::check_valid()
{
	...
	else if (this->_args[1].empty() || this->_args[1].find_first_not_of(" \t\n\r") == std::string::npos)
